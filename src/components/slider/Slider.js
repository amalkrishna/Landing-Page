      ...
      <Col sm={9}>
        <Carousel id="myCarousel" >
          <Carousel.Item data-slide-number="1">
            <img width={900} height={480} alt="900x500" src="/images/slider/slider1.png"/>
            <Carousel.Caption>
      ...
      <Col sm={3}>
        <ul className="hide-bullets">
            <li className="row" data-target="#myCarousel1" data-slide-to="1">
                <a className="thumnail over" id="carousel-selector-0"><img src="/images/slider/sl1.png" alt=""/></a>
            </li>

            <li className="row" data-target="#myCarousel1" data-slide-to="2">
                <a className="thumnail over" id="carousel-selector-1"><img src="/images/slider/sl2.png" alt=""/></a>
            </li>

            <li className="row" data-target="#myCarousel1" data-slide-to="3">
                <a className="thumnail over" id="carousel-selector-2"><img src="/images/slider/sl3.png" alt=""/></a>
            </li>

            <li className="row" data-target="#myCarousel1" data-slide-to="4">
                <a className="thumnail over" id="carousel-selector-3"><img src="/images/slider/sl4.png" alt=""/></a>
            </li>
